...
Int_t particle_yields(bool is_number = kTRUE, bool do_ref=kFALSE){
  ...
  TH1D *signal_dPhi_ref[12][nTrkPtBins][nCBins];
  ...
  TH1D *signal_dEta_ref[12][nTrkPtBins][nCBins];
  ...
  TH1D *spill_over_dEta2[12][nTrkPtBins][nCBins];
  TH1D *spill_over_dPhi2[12][nTrkPtBins][nCBins];
  ...
  */
  ...
  TFile *f_spillover2 = new TFile("../FROZEN_QM/spill_over/Inclusive_Hydjet_SpillOvers.root");
  ...
  for(int i = 0; i<nTrkPtBins-1; i++){
	...
	if(g==0){
	  ...
	  if(is_number)	  result[g][i][j] = (TH2D*)f_in_pbpb->Get((TString)("Yield_BkgSub_" + CBin_strs[j] + "_" + CBin_strs[j+1] + "_Pt100_Pt1000_" + TrkPtBin_strs[i] + "_" + TrkPtBin_strs[i+1]))->Clone((TString)("Yield_BkgSub_PbPb_" + CBin_strs[j] + "_" + CBin_strs[j+1] + "_Pt100_Pt1000_" + TrkPtBin_strs[i] + "_" + TrkPtBin_strs[i+1]));
	  else	  result[g][i][j] = (TH2D*)f_in_pbpb->Get((TString)("Yield_BkgSub_pTweighted" + CBin_strs[j] + "_" + CBin_strs[j+1] + "_Pt100_Pt1000_" + TrkPtBin_strs[i] + "_" + TrkPtBin_strs[i+1]))->Clone((TString)("Yield_BkgSub_PbPb_" + CBin_strs[j] + "_" + CBin_strs[j+1] + "_Pt100_Pt1000_" + TrkPtBin_strs[i] + "_" + TrkPtBin_strs[i+1]));
	  ...
	  if(is_number) result[g][i][j] = (TH2D*)f_in_pp->Get((TString)("Yield_BkgSub_Cent0_Cent10_Pt100_Pt1000_" + TrkPtBin_strs[i] + "_" + TrkPtBin_strs[i+1]))->Clone((TString)("Yield_BkgSub_pp_Cent0_Cent10_Pt100_Pt1000_" + TrkPtBin_strs[i] + "_" + TrkPtBin_strs[i+1]));
	  else  result[g][i][j] = (TH2D*)f_in_pp->Get((TString)("Yield_BkgSub_pTweightedCent0_Cent10_Pt100_Pt1000_" + TrkPtBin_strs[i] + "_" + TrkPtBin_strs[i+1]))->Clone((TString)("Yield_BkgSub_pp_pTweightedCent0_Cent10_Pt100_Pt1000_" + TrkPtBin_strs[i] + "_" + TrkPtBin_strs[i+1]));
	}
	if(is_number){  
	...
	*/
	...
	//	signal_dPhi_rebin[g][i][j] = (TH1D*) signal_dPhi[g][i][j]->Clone((TString)("Proj_dPhi_PbPb_CHECK" + CBin_strs[j] + "_" + CBin_strs[j+1]+"_"+TrkPtBin_strs[i] + "_" + TrkPtBin_strs[i+1]));
	...
	*/
	...
	if(do_ref){
	  if(g==0)	signal_dEta_ref[g][i][j] = (TH1D*)f_in_ref2->Get((TString)("Proj_dEta_PbPb_" + CBin_strs[j] + "_" + CBin_strs[j+1]+"_"+TrkPtBin_strs[i] + "_" + TrkPtBin_strs[i+1]+"_Rebin"))->Clone((TString)("Proj_dEta_PbPb_" + CBin_strs[j] + "_" + CBin_strs[j+1]+"_"+TrkPtBin_strs[i] + "_" + TrkPtBin_strs[i+1]+"_Ref"));
	  else	signal_dEta_ref[g][i][j] = (TH1D*)f_in_ref2->Get((TString)("Proj_dEta_pp_"+TrkPtBin_strs[i] + "_" + TrkPtBin_strs[i+1]+"_Rebin"))->Clone((TString)("Proj_dEta_pp_" + CBin_strs[j] + "_" + CBin_strs[j+1]+"_"+TrkPtBin_strs[i] + "_" + TrkPtBin_strs[i+1]+"_Ref"));


	  if(g==0)	signal_dPhi_ref[g][i][j] = (TH1D*)f_in_ref2->Get((TString)("Proj_dPhi_PbPb_" + CBin_strs[j] + "_" + CBin_strs[j+1]+"_"+TrkPtBin_strs[i] + "_" + TrkPtBin_strs[i+1]+"_Rebin"))->Clone((TString)("Proj_dPhi_PbPb_" + CBin_strs[j] + "_" + CBin_strs[j+1]+"_"+TrkPtBin_strs[i] + "_" + TrkPtBin_strs[i+1]+"_Ref"));
	  else	signal_dPhi_ref[g][i][j] = (TH1D*)f_in_ref2->Get((TString)("Proj_dPhi_pp_"+TrkPtBin_strs[i] + "_" + TrkPtBin_strs[i+1]+"_Rebin"))->Clone((TString)("Proj_dPhi_pp_" + CBin_strs[j] + "_" + CBin_strs[j+1]+"_"+TrkPtBin_strs[i] + "_" + TrkPtBin_strs[i+1]+"_Ref"));
										     
	  signal_dEta_ref[g][i][j]->SetLineColor(kRed);
	  signal_dEta_ref[g][i][j]->SetMarkerColor(kRed);
	  signal_dEta_ref[g][i][j]->SetMarkerStyle(20);
	  signal_dEta_ref[g][i][j]->SetMarkerSize(0.8);

          										     
	  signal_dPhi_ref[g][i][j]->SetLineColor(kRed);
	  signal_dPhi_ref[g][i][j]->SetMarkerColor(kRed);
	  signal_dPhi_ref[g][i][j]->SetMarkerStyle(20);
	  signal_dPhi_ref[g][i][j]->SetMarkerSize(0.8);

	  if(g==1){
	    signal_dEta_ref[g][i][j]->SetMarkerStyle(4);
	    signal_dPhi_ref[g][i][j]->SetMarkerStyle(4);
	  }
	...
	if(g==0&&i<4){
	  ...
	  spill_over_dEta2[g][i][j] = (TH1D*)f_spillover2->Get(spillover_name)->Clone((TString)(spillover_name+"old"));
	  ...
	  if(!is_number){
	    ...
	    if(i==0){
	      ...
	      spill_over_dEta2[g][i][j]->Scale(.3);
	...
	cout<<"RELATIVE JFF ERROR: "<<g<<" "<<i<<" "<<j<<" "<<jff_residual_dPhi[g][i][j]->Integral()/signal_dEta_rebin[g][i][j]->Integral()/2<<endl;
	...
	if(g==0){
	  ...
	  if(is_number)	  result[g][i][j] = (TH2D*)f_in_pbpb->Get((TString)("Yield_PbPb_" + CBin_strs[j] + "_" + CBin_strs[j+1] + "_Pt100_Pt1000_" + TrkPtBin_strs[i] + "_" + TrkPtBin_strs[i+1]))->Clone((TString)("Yield_PbPb_" + CBin_strs[j] + "_" + CBin_strs[j+1] + "_Pt100_Pt1000_" + TrkPtBin_strs[i] + "_" + TrkPtBin_strs[i+1]));
	  else	  result[g][i][j] = (TH2D*)f_in_pbpb->Get((TString)("Yield_pTweighted_PbPb_" + CBin_strs[j] + "_" + CBin_strs[j+1] + "_Pt100_Pt1000_" + TrkPtBin_strs[i] + "_" + TrkPtBin_strs[i+1]))->Clone((TString)("Yield_PbPb_" + CBin_strs[j] + "_" + CBin_strs[j+1] + "_Pt100_Pt1000_" + TrkPtBin_strs[i] + "_" + TrkPtBin_strs[i+1]));
	    
	}else{
	  
	  if(is_number) result[g][i][j] = (TH2D*)f_in_pp->Get((TString)("Yield_pp_Cent0_Cent10_Pt100_Pt1000_" + TrkPtBin_strs[i] + "_" + TrkPtBin_strs[i+1]))->Clone((TString)("Yield_BkgSub_pp_Cent0_Cent10_Pt100_Pt1000_" + TrkPtBin_strs[i] + "_" + TrkPtBin_strs[i+1]));
	...
	dummy->cd(0);
       	signal_dEta[g][i][j]->Fit("fit_line_left","q","",-2.5,-1.5);
	
	line_left = fit_line_left->GetParameter(0);

	signal_dEta[g][i][j]->Fit("fit_line_right","q","",1.5,2.5);
	...
	cout<<"at end of g loop"<<endl;
      ...
      signal_dEta_syst[0][i][j] = (TH1D*)signal_dEta_rebin[0][i][j]->Clone((TString)("dEta_Syst_PbPb_"+CBin_strs[j]+"_"+CBin_strs[j+1]+"_" + TrkPtBin_strs[i] + "_" + TrkPtBin_strs[i+1]));

      signal_dEta_syst[1][i][j] = (TH1D*)signal_dEta_rebin[1][i][0]->Clone((TString)("dEta_Syst_pp_"+CBin_strs[j]+"_"+CBin_strs[j+1]+"_" + TrkPtBin_strs[i] + "_" + TrkPtBin_strs[i+1]));

      signal_dPhi_syst[0][i][j] = (TH1D*)signal_dPhi_rebin[0][i][j]->Clone((TString)("dPhi_Syst_PbPb_"+CBin_strs[j]+"_"+CBin_strs[j+1]+"_" + TrkPtBin_strs[i] + "_" + TrkPtBin_strs[i+1]));

      signal_dPhi_syst[1][i][j] = (TH1D*)signal_dPhi_rebin[1][i][0]->Clone((TString)("dPhi_Syst_pp_"+CBin_strs[j]+"_"+CBin_strs[j+1]+"_" + TrkPtBin_strs[i] + "_" + TrkPtBin_strs[i+1]));
	...
	//	  cout<<"ERRORS "<<i<<" "<<j<<" "<<k<<" "<<bc<<" "<<bc*rel_err_pbpb<<" "<<jff_residual_dPhi[0][i][j]->GetBinContent(k)/2.<<" "<<me_err[0][i][j]<<" "<<bg_err[0][i][j]<<endl;
	...
	signal_dPhi_rebin[0][i][j]->GetXaxis()->CenterTitle();
      ...
      cout<<"here"<<endl;
      if(do_ref)   signal_dPhi_ref[1][i][0]->Draw("same");
      if(do_ref)   signal_dPhi_ref[0][i][j]->Draw("same");
	...
	signal_dEta_rebin[0][i][j]->GetXaxis()->CenterTitle();
      ...
      if(do_ref) signal_dEta_ref[1][i][0]->Draw("same");
      if(do_ref)   signal_dEta_ref[0][i][j]->Draw("same");
	...
	legend->AddEntry(signal_dPhi_syst[0][i][j],"PbPb");
	legend->AddEntry(signal_dPhi_syst[1][i][0],"pp");
	legend->SetTextSize(0.06);
	legend->SetLineColor(0);
	legend->Draw();
      }
	...
	dummy->cd();
      ...
      signal_dPhi_syst[0][i][j]->Write();
      signal_dPhi_syst[1][i][0]->Write();
      signal_dEta_syst[0][i][j]->Write();
      signal_dEta_syst[1][i][0]->Write();
  ...
  if(is_number){
    ...
    c_yields_phi->SaveAs((TString)("Yields_dPhi_Inclusive_pTweighted.png"));
    c_PbPb_pp_phi->SaveAs((TString)("Yields_dPhi_PbPb_minus_pp_Inclusive_pTweighted.png"));
    c_yields_eta->SaveAs((TString)("Yields_dEta_Inclusive_pTweighted.png"));
    c_PbPb_pp_eta->SaveAs((TString)("Yields_dEta_PbPb_minus_pp_Inclusive_pTweighted.png"));


    c_yields_phi->SaveAs((TString)("Yields_dPhi_Inclusive_pTweighted.pdf"));
    c_PbPb_pp_phi->SaveAs((TString)("Yields_dPhi_PbPb_minus_pp_Inclusive_pTweighted.pdf"));
    c_yields_eta->SaveAs((TString)("Yields_dEta_Inclusive_pTweighted.pdf"));
    c_PbPb_pp_eta->SaveAs((TString)("Yields_dEta_PbPb_minus_pp_Inclusive_pTweighted.pdf"));
  }
  ...
  if(is_number){
    ...
    TFile *f_int_r = TFile::Open("../jet_shapes_result/Jet_Shapes.root ");
	...
	if(g==0){
	  ...
	  Integral_r_Pt[g][j]= (TH1D*)f_int_r->Get((TString)("Integral_PbPb"+CBin_strs[j]+"_"+CBin_strs[j+1]))->Clone((TString)("Integral_PbPb"+CBin_strs[j]+"_"+CBin_strs[j+1]));
	  ...
	  Integral_r_Pt[g][j]= (TH1D*)f_int_r->Get("Integral_pp")->Clone("Integral_pp");
	}
	...
	Integral_r_Pt[g][j]->SetMarkerSize(1.5);
	Integral_r_Pt[g][j]->SetMarkerColor(kGreen);
	Integral_r_Pt[g][j]->SetLineColor(kGreen);
	...
	Integral_phi_Pt[0][j]->GetYaxis()->SetLabelSize(0.);
      ...
      Integral_r_Pt[0][j]->Draw("same");
      Integral_r_Pt[1][0]->Draw("same");

      if(j==3){
	TLegend *int_legend = new TLegend(0.18,0.55,0.9,0.85);
	...
	int_legend->AddEntry( Integral_r_Pt[0][j],"PbPb integral |#Delta r|<1.0");
	int_legend->AddEntry( Integral_r_Pt[1][0],"pp integral |#Delta r|<1.0");
	...
	labels->Draw("same");
      ...
      Integral_diff_Pt[2][j]->SetLineColor(kCyan);
      Integral_diff_Pt[2][j]->SetMarkerColor(kCyan);
