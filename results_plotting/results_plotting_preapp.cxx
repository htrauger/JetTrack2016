...
Int_t results_plotting_preapp(bool is_number=0,bool do_ref=kFALSE){
  ...
  TFile *f_in_ref_int = new TFile("../HIN_14_016_comparison/Inclusive_Data_AllPlots.root");
  ...
  for(int g=0; g<2; g++){
	...
	for (int ibin3=0;ibin3<nTrkPtBins;ibin3++){
	  ...
	  if(g==0){
	    ...
	    if(do_ref){
	      JetShape_ref[g][ibin][ibin3] = (TH1D*)f_in_ref->Get((TString)(stem +"pp_" + TrkPtBin_strs[ibin3] + "_" + TrkPtBin_strs[ibin3+1]))->Clone((TString) (stem + "_Ref_" + CBin_strs[ibin+1] + "_" +TrkPtBin_strs[ibin3]+"_" +TrkPtBin_strs[ibin3+1]));
	      JetShape_ref[g][ibin][ibin3]->SetMarkerColor(kCyan);
	      JetShape_ref[g][ibin][ibin3]->SetLineColor(kCyan);
	      JetShape_ref[g][ibin][ibin3]->SetMarkerSize(1);
	      JetShape_ref[g][ibin][ibin3]->SetMarkerStyle(20);
	  ...
	  if(!is_number&&ibin3==9){
	    ...
	    norm = JetShape[g][ibin][ibin3]->Integral(1,14,"width");
	    ...
	    if(do_ref){
	      ...
	      norm = JetShape_ref[g][ibin][ibin3]->Integral(1,14,"width");
  ...
  for (int ibin=0;ibin<nCBins;ibin++){ 
	...
	JetShape_syst[g+2][ibin][ibin3]->SetMarkerSize(1);
	  ...
	  if(do_ref&&ibin3==9){
	    ...
	    JetShape_ref_diff[g][ibin][ibin3] = (TH1D*)JetShape_ref[g][ibin][ibin3]->Clone((TString)(ratio_name+"_Ref"));
